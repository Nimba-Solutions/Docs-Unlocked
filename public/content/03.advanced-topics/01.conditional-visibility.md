...
You are seeing this message because you do not have the `Docs_Unlocked_User` permission set assigned to your user profile.
...
You are seeing this message because you are not a Docs Unlocked admin. You do not have the `Docs_Unlocked_Admin` permission set assigned to your user profile.

To view administrative content, contact your system administrator to request the `Docs_Unlocked_Admin` permission set.
:::
