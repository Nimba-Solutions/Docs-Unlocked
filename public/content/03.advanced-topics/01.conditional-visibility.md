...
> [!TIP]
> You are seeing this because you **have** the `Docs_Unlocked_User` permission set.
...
::else
> [!WARNING]
> You are seeing this because you *do not* have the `Docs_Unlocked_User` permission set assigned to your user profile.

To view user-specific content, contact your administrator to request the `Docs_Unlocked_User` permission set.
:::
...
:::if permission-set="Docs_Unlocked_Admin"
> [!TIP]
> You are seeing this because you **have** the `Docs_Unlocked_Admin` permission set.
...
> [!TIP]
> You are seeing this because you **have** both `Docs_Unlocked_Admin` and `CustomizeApplication`.
...
::else
> [!NOTE]
> You have `Docs_Unlocked_Admin` but *not* `CustomizeApplication`.

Standard admin content visible to all `Docs_Unlocked_Admin` users.
:::
::else
> [!WARNING]
> You are seeing this because you *do not* have the `Docs_Unlocked_Admin` permission set.

The Administrator Guide section is hidden. Contact your administrator for access.
:::
...
::else
Contact your administrator for access to admin features.
:::
...
::else
Contact your administrator for access to user features.
:::
```
...
::else
> [!WARNING]
> You are seeing this because you *do not* have the `Docs_Unlocked_User` permission set.
...
::else
Beta features are not available to you.
:::
```
...
:::if custom-permission="Access_Beta_Docs"
> [!TIP]
> You are seeing this because you **have** the `Access_Beta_Docs` custom permission.
...
::else
> [!WARNING]
> You are seeing this because you *do not* have the `Access_Beta_Docs` custom permission.
...
::else
You do not have read access to Opportunities.
:::
...
::else
You do not have edit access to Accounts.
:::
```
...
:::if object="Opportunity" access="read"
> [!TIP]
> You are seeing this because you **have** read access to the `Opportunity` object.
...
::else
> [!WARNING]
> You are seeing this because you *do not* have read access to the `Opportunity` object.
...
:::if object="Account" access="edit"
> [!TIP]
> You are seeing this because you **have** edit access to the `Account` object.
...
::else
> [!WARNING]
> You are seeing this because you *do not* have edit access to the `Account` object.
...
:::
::else
You need either Docs_Unlocked_Admin or Docs_Unlocked_User permission set.
:::
```
...
:::if any="Docs_Unlocked_Admin, Docs_Unlocked_User"
> [!TIP]
> You are seeing this because you **have** either `Docs_Unlocked_Admin` or `Docs_Unlocked_User` permission set.
...
::else
> [!NOTE]
> The Admin Section above is hidden because you *do not* have the `Docs_Unlocked_Admin` permission set.
:::
::else
> [!WARNING]
> You are seeing this because you *do not* have either `Docs_Unlocked_Admin` or `Docs_Unlocked_User` permission set.
