...
> [!IMPORTANT]
> Only necessary if your contributions modify the React app in `src/`.
...
Both commands compile TypeScript, bundle the React app with Vite, inline CSS into the JS bundle, copy the bundle to the StaticResource location, and package content into `docsContent.zip`. 
...
For more detailed solutions, see the [Troubleshooting](/getting-started/troubleshooting) guide.
