...
**Default** (navigation structure is derived from your content directories):
```bash
npm run build:sf
```

**With Manifest** (navigation structure is derived from your `manifest.yaml` file):
```bash
...
│   │   ├── ContentRenderer.tsx
│   │   ├── DocsApp.tsx     # Main app component
│   │   ├── NavCard.tsx
│   │   ├── NavigationLinks.tsx
│   │   ├── SearchModal.tsx
│   │   └── Sidebar.tsx
│   ├── hooks/               # Custom React hooks
│   │   └── useContentEffects.tsx
...
│   ├── main.tsx
│   └── salesforce.tsx       # Re-export hub
├── force-app/
│   └── main/default/
│       ├── classes/         # Apex classes
│       │   ├── StaticResourceTree.cls
│       │   └── StaticResourceTreeTest.cls
│       ├── lwc/
...
├── scripts/
│   ├── create-content-staticresource.js  # Creates content ZIP
│   ├── inline-css.js        # Inlines CSS into JS bundle
│   └── copy-to-staticresource.js  # Copies bundle to StaticResource
...
> 💡 **Pro Tip**: Before starting on a large feature, consider opening an issue to discuss it first. This helps ensure your work aligns with the project's direction and avoids duplicate effort.
